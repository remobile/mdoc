...
class Head extends React.Component {
    render() {
        ...
        const { favicon, projectName, highlight }  = config;
        ...
        return (
            <head>
                ...
                <link rel="stylesheet" href={`/${projectName}/${theme}.css`} />
                <link rel="stylesheet" href={`/${projectName}/css/main.css`} />
                <script type="text/javascript" src={`/${projectName}/js/jquery-1.4.4.min.js`} />
                <script type="text/javascript" src={`/${projectName}/js/underscore-min.js`} />
                {/* 是否支持ztree-toc */}
