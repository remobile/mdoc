                                      ...
                                      <div className="layui-form-item">
                                        ...
                                        <div className="layui-input-block">
                                            <select lay-filter="myselect">
                                                ...
                                                <option value="SimSun">中心放大</option>
                                                <option value="SimHei">从上划入</option>
                                                <option value="KaiTi">从下划入</option>
                                                <option value="SimHei">从左划入</option>
                                                <option value="KaiTi">从右划入</option>
                                             </select>
                                        </div>
                                      </div>
                                      <div className="layui-form-item">
